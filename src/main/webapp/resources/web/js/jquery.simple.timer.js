...
(function($){
  ...
  Timer.prototype.clearTimer = function(element){
    element.find('.seconds').text('00초');
    element.find('.minutes').text('00분');
    element.find('.hours').text('00시간');
  };
  ...
  Timer.prototype.setFinalValue = function(finalValues, element) {
    ...
    element.find('.seconds').text(finalValues.pop() + '초');
    element.find('.minutes').text(finalValues.pop() + '분');
    element.find('.hours').text(finalValues.pop() + '시간');
  };
